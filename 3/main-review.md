  ...
  <div class="tab-content">
	...
	<div role="tabpanel" class="tab-pane" id="menu3"><h3>Випуск №3</h3>
		...
		<ul type="disc">
			...
			<li style="list-style-type: none; margin-left: -20px;"><img src="../img/video-solid.svg" height="15px;" style="margin-right: 4px;">Відеолекція: «Право на мирне володіння своїм майном»</li>
			<li>Переклад рішень
				<ul>
